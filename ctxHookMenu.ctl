...
'
' 2005-02-28    OLM     Add 2003 LookAndFeel Features
'                       Modification tag OLM001
'
'ToDo:Change Menu Bar Appearance
'==============================================================================
Option Explicit
...
'OLM001 2005-02-28 Begin
Private Const DEF_MENULOOK          As Long = 0
'OLM001 2005-02-28 End
...
'OLM001 Begin 2005-02-28
Public Enum MENU_LOOK
    MenuXP = 0
    Menu2003 = 1
End Enum
Private m_MenuLook              As MENU_LOOK
Private m_GradFirstColor        As OLE_COLOR
Private m_GradLastColor         As OLE_COLOR
'OLM001 End 2005-02-28
...
'==============================================================================
'OLM001 Begin 2005-02-28
Property Get MenuLook() As MENU_LOOK
    MenuLook = m_MenuLook
End Property

Property Let MenuLook(ByVal New_MenuLook As MENU_LOOK)
    m_MenuLook = New_MenuLook
    pvGetMeasures
    PropertyChanged ("MenuLook")
End Property
'OLM001 End 2005-02-28
...
Private Sub pvGetMeasures()
    ...
    If m_bConstrainedColors Then
        ...
        m_clrMenuBack = &HD8E9EC   'vbButtonFace
        m_clrMenuFore = vbMenuText
        m_clrDisabledMenuBorder = vbButtonText
        m_clrDisabledMenuBack = m_clrSelMenuBack
        m_clrDisabledMenuFore = vbGrayText
        If pvIsAppearanceXpStyle() Then
            m_clrMenuBarBack = &HD8E9EC 'GetSysColor(COLOR_MENUBAR)
        Else
    ...
    Else
        '--- calc normal colors
        'OLM001 Begin 2005-02-28
        Select Case m_MenuLook
        Case MENU_LOOK.MenuXP
        'OLM001 End 2005-02-28
            ...
            m_clrMenuBack = pvAlphaBlend(&HD8E9EC, vbWindowBackground, 214)   'vbButtonFace
            ...
            m_clrMenuPopupBack = vbWindowBackground
        'OLM001 Begin 2005-02-28
        Case MENU_LOOK.Menu2003
            m_clrSelMenuBorder = &HC66931
            m_clrSelMenuBack = &HC2EEFF
            m_clrSelMenuFore = vbMenuText
            m_clrCheckBack = &H6FC0FF
            m_clrCheckFore = m_clrSelMenuFore
            m_clrSelCheckBack = &H3E80FE
            m_clrMenuBorder = &HC66931 'vbButtonShadow
            m_clrMenuBack = &HEFD3C6
            m_clrMenuFore = vbWindowText
            m_clrDisabledMenuBorder = &HC66931  'vbButtonShadow
            m_clrDisabledMenuBack = pvAlphaBlend(m_clrMenuBack, vbWindowBackground, 128)
            m_clrDisabledMenuFore = vbGrayText
            If pvIsAppearanceXpStyle Then
                m_clrMenuBarBack = &HF8E4D8   'GetSysColor(COLOR_MENUBAR)
            Else
                m_clrMenuBarBack = vbMenuBar
            End If
            m_clrMenuPopupBack = vbWindowBackground
            m_GradFirstColor = &HFEECDD
            m_GradLastColor = &HE7B592
        End Select
        'OLM001 End 2005-02-28
    End If
        ...
        With New cMemDC
            ...
            If bMainMenu Then
                ...
                If (lState And MF_GRAYED) = 0 Then
                    ...
                    Case MENU_LOOK.Menu2003
                        ...
                        If (dis.itemState And ODS_SELECTED) <> 0 Then
                            .Rectangle dis.rcItem.Left, dis.rcItem.top, dis.rcItem.Right, dis.rcItem.Bottom, m_clrSelMenuBack, , m_clrSelMenuBorder
                            .FillGradient dis.rcItem.Left + 1, dis.rcItem.top + 1, dis.rcItem.Right - 1, dis.rcItem.Bottom - 1, m_GradFirstColor, m_GradLastColor, True
                        ElseIf (dis.itemState And ODS_HOTLIGHT) <> 0 Then
                            .Rectangle dis.rcItem.Left, dis.rcItem.top, dis.rcItem.Right, dis.rcItem.Bottom, m_clrSelMenuBack, , m_clrSelMenuBorder
                            .ForeColor = m_clrSelMenuFore
                        End If
            ...
            Else
                ...
                Case MENU_LOOK.MenuXP
                    ...
                    End If
                Case MENU_LOOK.Menu2003
                    'Todo Insert managment of office XP/2003 Look and feel
                    'Si 2003 Gradient style -> set brush sur dégradé avant
                    If (lType And MFT_RIGHTJUSTIFY) = 0 Then
                        .FillGradient dis.rcItem.Left, dis.rcItem.top, dis.rcItem.Left + m_lMenuHeight + 3, dis.rcItem.Bottom, m_GradFirstColor, m_GradLastColor
                    Else
                        .FillGradient dis.rcItem.Right - m_lMenuHeight - 4, dis.rcItem.top, dis.rcItem.Right - 1, dis.rcItem.Bottom, m_GradFirstColor, m_GradLastColor
                    End If
                End Select
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    With PropBag
        ...
        'OLM001 Begin - 20050228
        m_MenuLook = .ReadProperty("MenuLook", DEF_MENULOOK)
        'OLM001 End - 20050228
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    With PropBag
        ...
        'OLM001 Begin - 20050228
        Call .WriteProperty("MenuLook", m_MenuLook, DEF_MENULOOK)
        'OLM001 End - 20050228
